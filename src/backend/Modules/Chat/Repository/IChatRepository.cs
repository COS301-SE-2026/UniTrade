...
public interface IChatRepository
{
    ...
    Task <IReadOnlyList<ChatMessage>> GetHistoryAsync(Guid reservationId, int? before,int limit, CancellationToken ct=default);
    Task<int> MarkReadAsync(Guid reservationId, Guid readerId,int upToMessageId,CancellationToken ct=default);
