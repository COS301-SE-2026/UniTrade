...
public class SavedSearchService : IListingPublishedListener, ISavedSearchService
{
    ...
    public SavedSearchService(ISavedSearchRepository repo, INotificationDispatcher notifications, IBroadCastService broadcast, IEmailService emailService, IUserRepository userRepo, ILogger<SavedSearchService> logger)
    {
        _repo = repo;
