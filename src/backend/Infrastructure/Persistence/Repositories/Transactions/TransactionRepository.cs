...
public class TransactionRepository: ITransactionRepository
{
    ...
    public Task<Transaction?> GetByReservationIdTrackedAsync(Guid reservationId,CancellationToken ct=default)=>_db .Transactions.FirstOrDefaultAsync(t=>t.ReservationId==reservationId);
    public async Task AddAsync(Transaction transaction,CancellationToken ct=default)=>await _db.Transactions.AddAsync(transaction,ct);
