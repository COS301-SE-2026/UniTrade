...
{
    /// <inheritdoc />
    public partial class AddSavedSearchToNotificationType : Migration
    {
        /// <inheritdoc />
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(
                @"ALTER TABLE unitrade.notifications ADD CONSTRAINT chk_notif_type CHECK (type IN ('listing_status', 'reservation_status', 'meetup_reminder', 'chat', 'dispute', 'verification'));"
            );
        }
    }
}
