        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    otp_code_hash = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    ...
                    ai_confidence_score = table.Column<decimal>(type: "numeric(5,2)", precision: 5, scale: 2, nullable: true),
                    ai_decision = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    ...
                    status = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false, defaultValue: "otp_pending"),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("chk_vr_status", "status IN ('otp_pending', 'por_pending','under_review','approved', 'rejected')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    listing_id = table.Column<Guid>(type: "uuid", nullable: false, defaultValueSql: "gen_random_uuid()"),
                    ...
                    listing_status = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    ai_risk_score = table.Column<decimal>(type: "numeric(5,2)", precision: 5, scale: 2, nullable: true),
                    ai_risk_level = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: true),
                    visibility_score = table.Column<int>(type: "integer", nullable: true, defaultValue: 100),
                    is_bundle = table.Column<bool>(type: "boolean", nullable: true, defaultValue: false),
                    rejection_reason = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("chk_listing_book_fields", "listing_type ='book'  OR (course_id IS NULL AND isbn IS NULL AND author IS NULL AND edition IS NULL)");
                    table.CheckConstraint("chk_listing_condition", "condition IN ('new', 'good', 'fair', 'poor')");
                    table.CheckConstraint("chk_listing_price", "price > 0");
                    table.CheckConstraint("chk_listing_risk", "ai_risk_level IS NULL OR ai_risk_level IN ('low', 'medium', 'high')");
                    table.CheckConstraint("chk_listing_type", "listing_type IN ('book', 'laptop', 'stationery', 'electronics', 'clothing', 'furniture', 'other')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    reputation_score = table.Column<decimal>(type: "numeric(4,2)", precision: 4, scale: 2, nullable: false, defaultValue: 0m)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_student_profiles", x => x.student_id);
                    table.CheckConstraint("chk_student_verification", "verification_status IN ('pending', 'partial', 'verified', 'rejected')");
