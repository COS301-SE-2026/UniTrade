      ...
      <p className="text-xs text-slate-400 mt-1"> Update your Listing details down below.</p>
        ...
        {/*Basic info block*/}
          ...
          <div className="flex flex-col md:flex-row gap-6 items-start">
            ...
            <h4 className="text-sm font-bold text-slate-900">Step 1: Basic Information</h4></div>
          ...
          {(["Textbook", "Electronics", "Furniture", "Other"] as const).map((cat) => (
            <button
              ...
              className={`px-4 py-2 rounded-xl text-xs font-bold capitalize transition-all border ${
                formData.category === cat ? "bg-[#0F2D5E] text-white border-transparent shadow-sm" : "bg-slate-50 text-slate-500 border-slate-200 hover:bg-slate-100"
              }`}
            >
              {cat}
            </button>
...
{/*Confirmation Summary */}
 <div className="relative">
      ...
      <div className="flex justify-end gap-4 mt-8 pt-4 border-t border-slate-200">
        ...
        <button type="submit" className="px-6 py-2.5 bg-[#0F2D5E] text-white rounded-xl text-sm font-bold tracking-wide hover:bg-sky-900 transition-all shadow-md">Save Changes
        </button>
