              ...
              <div key={section.heading}>
                ...
                {section.items.map((item) => (
                  <NavLink 
                    ...
                    className={({isActive}) =>
                    clsx(
                      'flex items-center gap-3 px-4 py-2.5 text-[12.5px] transition-colors', collapsed && 'justify-center px-0',
                      isActive
        ...
        <div className={clsx(
          ...
          {!collapsed && (
            <div className="min-w-0">
              ...
              <p className="text-[10px] text-white/50 capitalize">{user.role} Account</p>
            </div>
          )}
        </div>
      )}
