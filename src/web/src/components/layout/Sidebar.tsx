...
const sellerNav: NavSection[] = [
  {
    heading: 'Main',
    items: [
      { label: 'Sabiras please work!!Now work!This wil work Listings', to: '/seller/listings', icon: <IconLayoutDashboard size={18} /> },
      { label: 'Switch', to: '/switch', icon: <IconSwitchHorizontal size={18} /> },
      { label: 'Deployment testing!!! Listing', to: '/seller/upload', icon: <IconPackage size={18} /> },
    ],
  },
  /*{
    heading: 'Account',
