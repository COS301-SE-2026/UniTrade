...
export async function acknowledgeReservatioin(
  ...
  const res = await fetch(
    `${getApiUrl()}/reservations/${reservationId}/acknowledge`,
    {
      method: "POST",
      credentials: "include",
      headers: { "Content-Type": "application/json" },
...
export async function createTransactionRequest(
  ...
  try {
    const res = await fetch(
      `${getApiUrl()}/reservations/${reservationId}/Transaction-request`,
      {
        method: "POST",
        credentials: "include",
      },
    ...
    if (!res.ok) {
      ...
      return {
        success: false,
        error: { code: body?.code ?? "unknown_error", status: res.status },
      };
    }
...
export async function getTransactionStatus(
  ...
  try {
    const res = await fetch(
      `${getApiUrl()}/reservations/${reservationId}/transaction-status`,
      {
        credentials: "include",
      },
    );
...
export async function verifyPin(
  ...
  try {
    const res = await fetch(
      `${getApiUrl()}/reservations/${reservationId}/verify-pin`,
      {
        method: "POST",
        credentials: "include",
        headers: { "Content-Type": "application/json" },
...
export async function getPendingPin(
  ...
  try {
    const res = await fetch(
      `${getApiUrl()}/reservations/${reservationId}/pending-pin`,
      {
        credentials: "include",
      },
    );
